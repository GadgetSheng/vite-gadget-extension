    ...
    (event) => {
      ...
      reader.onload = () => {
        try {
          ...
          void setExtensionState({ rules: nextRules, globalEnabled: nextGlobal, variables: nextVars })
          setExpandedId(null)
        } catch {
    ...
    <div className="demo-app">
      <div className="demo-top-sticky">
        <header className="demo-header">
          <div className="demo-header__brand">
            ...
            <div className="demo-header__tabs" role="tablist" aria-label="主视图">
              <button
                type="button"
                role="tab"
      ...
      <main className="demo-main">
        {hydrated && mainTab === 'variables' ? (
          <VariablesEditor key={varEditorKey} initialVariables={variables} onChange={setVariables} />
        ) : null}
        {mainTab === 'rules' ? (
              ...
              {expanded && (
                <div className="demo-card__detail">
                  <PayloadTabsEditor
                    ...
                    onFieldChange={(field, value) => updateRule(rule.id, { [field]: value })}
